...
export const CodeEditor: React.FC<CodeEditorProps> = React.memo(
    ({ code, onCodeChange, onShowVersionModal, codeSaved, isCodeValid, errorInfo, onValidationChange, isMaximized = false, onToggleMaximize }) => {
                    ...
                    <div className="mb-4 bg-tuna-900 border border-teal-200 rounded-lg p-4">
                        ...
                        <div className="text-sm space-y-2">
                            ...
                            <ul className="list-disc list-inside ml-4 space-y-1">
                                ...
                                <li>
                                    <code className="bg-tuna-600 px-1 rounded">result.price = data.currentBar.close</code> - Execution price (will use next next bar open price if
                                    not set)
                                </li>
                                <li>
...
/// <reference lib="dom" />`,
                ...
                {!isMaximized && (
                    <div className="text-xs text-tuna-400 mt-3">
